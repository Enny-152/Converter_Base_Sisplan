...
if not %ERRORLEVEL% == 1 (
  ...
  if exist "C:\Program Files (X86)\Firebird\Firebird_3_0\firebird.exe" (
  ...
  Firebird-3.0.10.33601_0_Win32.exe/TASKS="UseClassicServerTask,UseServiceTask,AutoStartTask,CopyFbClientToSysTask" /SYSDBAPASSWORD="masterkey" /SILENT
  copy 3051\firebird.conf "C:\Program Files (x86)\Firebird\Firebird_3_0"
  copy tbudf.dll "C:\Program Files (x86)\Firebird\Firebird_3_0\UDF"
  ...
  Echo Reiniciando servico antigo...
